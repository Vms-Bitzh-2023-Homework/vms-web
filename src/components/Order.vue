    ...
    <el-dialog v-model="editOrderVisible" title="修改订单信息">
        ...
        <template #footer>
            <span class="dialog-footer">
                ...
                <el-button type="primary" @click="confirmEditOrder">
                    确定
                </el-button>
            </span>
        </template>
...
// };
const calcMoney2 = () => {
    editOrderFrom.money = editOrderFrom.parkingTime * 0.0167;
};
// 确认修改
const confirmEditOrder = () => {
    http.put("/order", editOrderFrom)
        .then((res: any) => {
...
//     http.post("/order", createOrderFrom)
//         .then((res: any) => {
